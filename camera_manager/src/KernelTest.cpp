...
// KernelProducer::KernelProducer(CameraConfig camera_config) {
//     this->cam_id = camera_config.cam_id;
//     m_name = "KernelProducer_" + camera_config.name;
...
//         // }
//         // 这里我们创建一个简单的测试数据包
//         m_testDataSize = m_status.width * m_status.height * 3 / 2;  // YUV420P大小
...
// KernelProducer::~KernelProducer() {
//     delete m_channel2decoder;
//     delete m_channel2rtsp;
// }

// void KernelProducer::start() {
//     TaskManager::start();
// }

// void KernelProducer::stop() {
//     TaskManager::stop();
// }

// void KernelProducer::run() {
//     open_mp4:   // 循环打开的入口
//     {
//         // int ret = avformat_open_input(&fmt_ctx, cam_path.c_str(), nullptr, &options);
//         // while(ret < 0) 
//         // {
//         //     LOG_ERROR("No MP4.Reconnecting......");
//         //     ret = avformat_open_input(&fmt_ctx, cam_path.c_str(), nullptr, &options);
//         //     std::this_thread::sleep_for(std::chrono::milliseconds(50));
//         // }
