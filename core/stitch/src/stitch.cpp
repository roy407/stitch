...
// extern "C" __global__ __aicore__ void stitch_y_uv_kernel(uint8_t* const* inputs_y, uint8_t* const* inputs_uv,
...
// extern "C" __aicore__ void stitch_y_uv_with_linesize_kernel_old(
...
// extern "C" __aicore__ void stitch_rgb_kernel(uint8_t* const* inputs_r, uint8_t* const* inputs_g, uint8_t* const* inputs_b,
...
// extern "C" __aicore__ void applyHomography(float* H, float x, float y, float* out_x, float* out_y) {
...
// extern "C" __aicore__ void stitch_withH(
//     uint8_t* const* inputs_y, uint8_t* const* inputs_uv,
//     int* input_linesize_y, int* input_linesize_uv,
...
// extern "C" __aicore__ bool is_point_in_quadrilateral(float x, float y,
...
// // 双线性插值采样
// extern "C" __aicore__ uint8_t bilinear_interp(
...
// // 计算混合权重（线性渐变）
// extern "C" __aicore__ float compute_blend_weight(int x, int y, 
...
// extern "C" __global__ __aicore__ void USE_HNI(
//     uint8_t* const* inputs_y, uint8_t* const* inputs_uv,
//     int* input_linesize_y, int* input_linesize_uv,
//     float* h_matrices, uint8_t* output_y, uint8_t* output_uv,
//     int output_linesize_y, int output_linesize_uv,
...
// extern "C" __aicore__ void stitch_y_uv_with_linesize_and_crop_kernel(
//     uint8_t* const* inputs_y, uint8_t* const* inputs_uv,
//     int* input_linesize_y, int* input_linesize_uv,
//     uint8_t* output_y, uint8_t* output_uv,
//     int output_linesize_y, int output_linesize_uv,
...
void launch_stitch_kernel_raw(
    ...
    stitch_y_uv_with_linesize_kernel<<<cam_num, nullptr, stream>>>(
        inputs_y, inputs_uv,
        input_linesize_y, input_linesize_uv,
        output_y, output_uv,
        output_linesize_y, output_linesize_uv,
