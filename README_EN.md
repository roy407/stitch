...
- 📷 [camera_manager | Camera and Thread Management](camera_manager/README_EN.md)
- 🧠 [core | Operator Library and Core Functions](core/README_EN.md)
- 🧩 [components | Functional Components (Qt / shm)](components/README_EN.md)
- 🗂️ [resource | Camera and Stitching Configuration Files](resource/README.md)
