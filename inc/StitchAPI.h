 ...
 * @brief 初始化相机管理器实例
 * @param handle 句柄指针
 * @return STITCH_OK 或错误码
 */
CAMERA_MANAGER_API STITCH_STATUS
camera_manager_init_instance(api_handle* handle);
 ...
 */
CAMERA_MANAGER_API STITCH_STATUS
camera_manager_start(api_handle* handle);
 ...
 */
CAMERA_MANAGER_API STITCH_STATUS
camera_manager_stop(api_handle* handle);
 ...
 */
CAMERA_MANAGER_API STITCH_STATUS
camera_manager_set_stitch_callback(api_handle* handle,
                                   int pipeline_id,
 ...
 */
CAMERA_MANAGER_API STITCH_STATUS
camera_manager_set_camera_callback(api_handle* handle,
                                   int cam_id,
                                   stitch_callback_t callback);
...
camera_manager_get_stream_count(api_handle* handle);
 ...
 */
CAMERA_MANAGER_API STITCH_STATUS
camera_manager_set_config_filename(api_handle* handle,
                                   const char* cfg_name);
...
camera_manager_get_config_filename(api_handle* handle);
 ...
 */
CAMERA_MANAGER_API STITCH_STATUS
camera_manager_reload_config(api_handle* handle);
